...
const Team: React.FC = () => {
  return (
    <section className="py-6 px-24 dark:bg-gray-100 dark:text-gray-800">
      <div className="container p-4 mx-auto space-y-1 sm:p-10">
        <div className="space-y-4 text-center">
          <h3 className="text-2xl font-bold leading-none sm:text-5xl">Meet the Developer</h3>
          <p className="dark:text-gray-600">At a assumenda quas cum earum ut itaque commodi saepe rem aspernatur quam natus quis nihil quod, hic explicabo doloribus magnam neque, exercitationem eius sunt!</p>
        </div>
