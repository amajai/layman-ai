          ...
          <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-12 lg:gap-x-8">
            <div>
              <div className="text-center lg:text-left  mb-10">
                <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:leading-tight lg:text-6xl font-pj">Simplify Complexity with Layman AI</h1>
                <p className="mt-2 text-lg text-gray-600 sm:mt-8 font-inter">Transform intricate text into clear, easy-to-understand language effortlessly.</p>
              ...
              <div className="sm:flex sm:items-center sm:justify-center lg:justify-start sm:space-x-5 lg:mt-12">
                ...
                >
                  ...
                  <svg className="mr-2 size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <ModalContent>
                    {(onClose) => (
                      <>
                        ...
                        <ModalBody>
                          <p>
                            <span className="text-primary">Layman AI</span> is a revolutionary web application designed to make complex 
